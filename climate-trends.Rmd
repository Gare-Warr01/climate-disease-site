...
# Color palette similar to your flu site look
...
<div style="background-color:#ffffff; padding:16px 18px; border-radius:4px; margin-top:10px; box-shadow:0 0 0 1px #e5e5e5;">
...
<p>
If this trend line slopes upward, it means that on average, the U.S. is getting <strong>warmer over time</strong>.
</p>
...
<ul>
  <li><strong>first_year / last_year</strong> – the time span covered by the data.</li>
  <li><strong>mean_anomaly</strong> – the average temperature change relative to the baseline.</li>
  <li><strong>min_anomaly / max_anomaly</strong> – the coolest and warmest years compared to the baseline.</li>
</ul>
...
<ul>
  <li><strong>mean_pdsi</strong> – the average moisture level across all years.</li>
  <li><strong>min_pdsi / max_pdsi</strong> – the driest and wettest years in the record.</li>
</ul>
...
<ul>
  <li><strong>correlation</strong> – how strongly temperature and PDSI move together:
    <ul>
  ...
  <li><strong>p_value</strong> – whether that pattern is likely to be real or just random noise.</li>
</ul>
...
<div style="background-color:#f3f7ff; padding:20px 24px; border-radius:4px; margin-bottom:25px; box-shadow:0 0 0 1px #dbe4ff;">
...
```{r cvi_summary}
summary(climate_cvi$`Overall CVI Score`)
```
...
<p>
This summary shows the <strong>minimum</strong>, <strong>maximum</strong>, and <strong>typical (median)</strong> CVI scores across states.  
...
<div style="background-color:#eaf2ff; padding:20px 24px; border-radius:4px; margin-bottom:25px; box-shadow:0 0 0 1px #d3dff5;">
